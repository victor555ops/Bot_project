...
def abrir_segunda():
  ...
  imagen2 = Image.open("paisaje2.jpg")
  foto2 = ImageTk.PhotoImage(imagen2)
  
  marco = tk.Frame(ventana_segunda)
  marco.pack()
...
icono_hablar_img = icono_hablar_img.convert("RGB")
icono_hablar_img = icono_hablar_img.filter(ImageFilter.BLUR)
icono_hablar_img = icono_hablar_img.resize((tamaño_icono[0], tamaño_icono[1]), Image.NEAREST)
icono_hablar = ImageTk.PhotoImage(icono_hablar_img)

icono_ayuda_img = Image.open("interrogacion.jpg")
icono_ayuda_img = icono_ayuda_img.convert("RGB")
icono_ayuda_img = icono_ayuda_img.filter(ImageFilter.BLUR)
icono_ayuda_img = icono_ayuda_img.resize(tamaño_icono, Image.BICUBIC)
